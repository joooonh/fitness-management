...
<div class="container-fluid mt-4">
	<div class="row">
		...
		<div class="col-md-10 ps-4 pt-5">
			...
			<div class="row">
				<div class="col-12">
					<span><h5 class="" ><i class="bi bi-pc-display-horizontal ms-2 me-3"></i>프로그램 수정</h5></span>
							...
							<tr>
								...
								<td>
									<select class="form-select" name="status">
										<option value="신청중" ${programDetail.status eq '신청중' ? 'selected' : '' } >신청중</option>
										<option value="진행중" ${programDetail.status eq '진행중' ? 'selected' : '' } >진행중</option>
										<option value="마감" ${programDetail.status eq '마감' ? 'selected' : '' } >마감</option>
									</select>
								</td>
							</tr>
						</table>

					...
					<div class="row ">
						<div class="col-md-2 mt-2">
							<a href="" class="navbar-brand"> <img
								src="https://svgsilh.com/svg/179520.svg" alt="Logo" width="40"
								height="27" class="d-inline-block align-text-top me-2 img-logo">중앙피트니스
							</a>
						</div>
						<div class="col-md-10">
							<ul class="navbar-nav justify-content-end">
								<span class="navbar-text"><strong class="text-white">홍길동</strong>님
									환영합니다.</span>
